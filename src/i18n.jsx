...
export const UI = {
  en: {
    ...
    shareCardTitle: "FAMILY TRIVIA BATTLE",
    shareWinnerLabel: "👑 WINNER",
    sharePoints: "points",
    shareWonText: "{name} won! 🏆",
  ...
  he: {
    ...
    strong: "💪 חזק: {t}",
    weak: "📚 חלש: {t}",
    bestStreak: "🔥 רצף שיא: {n}",
    chooseAvatar: "בחרו דמות",
    shareResult: "📸 שתפו תוצאה",
    shareCardTitle: "קרב טריוויה משפחתי",
    shareWinnerLabel: "👑 המנצח/ת",
    sharePoints: "נקודות",
    shareWonText: "{name} ניצח/ה! 🏆",
